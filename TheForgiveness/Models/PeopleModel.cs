...
namespace TheForgiveness.Models
{
    public class PeopleModel
    {
        ...
        public PeopleModel(int ID, long NumIdentificacion, string PriNombre, string SegNombre, string PriApellido, string SegApellido, string FechaNacimiento, int Genero, int TipoDocumento, int Municipio)
        {
            this.ID = ID;
        ...
        public PeopleModel(long NumIdentificacion, string PriNombre, string SegNombre, string PriApellido, string SegApellido, string FechaNacimiento, int Genero, int TipoDocumento, int Municipio)
        {
            this.NumIdentificacion = NumIdentificacion;
            this.PriNombre = PriNombre;
            this.SegNombre = SegNombre;
