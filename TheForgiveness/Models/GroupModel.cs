...
namespace TheForgiveness.Models
{
    public class GroupModel
    {
        ...
        public GroupModel(int Codigo, string Nombre, int AñoEscolar, int Docente, int Asignatura, int Colegio)
        {
            this.Codigo = Codigo;
            this.Nombre = Nombre;
        ...
        public GroupModel(int ID, int Codigo, string Nombre, int AñoEscolar, int Docente, int Asignatura, int Colegio)
        {
            this.ID = ID;
            this.Codigo = Codigo;
            this.Nombre = Nombre;
