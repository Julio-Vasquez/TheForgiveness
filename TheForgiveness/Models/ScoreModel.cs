...
//lequite la validacion, porque este dato lo inserta el procedimiento
        ...
        public ScoreModel(int ID, int Nota, DateTime FechaNota, string Concepto, int Grupo, int Estudiante)
        {
            this.ID = ID;
            this.Nota = Nota;
        ...
        public ScoreModel(int Nota, string Concepto, string State, int Grupo, int Estudiante)
        {
            this.Nota = Nota;
            this.Concepto = Concepto;
            this.Grupo = Grupo;
